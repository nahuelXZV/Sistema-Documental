<aside
    class="z-20 flex-shrink-0 hidden w-60 pl-2 overflow-y-auto bg-white md:block text-black border-r border-gray-200 ">
    <div class="">
        <div class="text-black ">
            <div class="flex p-2 mt-2 bg-white">
            ...
            <div class=" h-full">
                <ul class="mt-6 leading-10">
                    ...
                    @role('admi')
                        <li>
                            <a href="{{ route('medico_horario.index') }}"
                                class="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
                                    fill="currentColor">
                                    <path fill-rule="evenodd"
                                ...
                                <span class="ml-3">Horarios de medicos</span>
                            </a>
                        </li>
                    @endrole
                    @hasanyrole('admi|medico')
                        <li>
                    ...
                    @role('paciente')
                        <li>
                            <a href="{{ route('paciente.index') }}"
                                ...
                                <span class="ml-3">Reservar</span>
                            </a>
                        </li>
                        @if (auth()->user()->paciente_id)
                            <li>
                                <a href="{{ route('historial.index', auth()->user()->paciente_id) }}"
                                    class="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20"
                                        fill="currentColor">
                                        <path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z" />
