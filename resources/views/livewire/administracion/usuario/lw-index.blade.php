    ...
    <x-header-table>
                ...
                <ul class=" dropdown-menu
                    ...
                    <li>
                        <div class="form-check ml-2 mr-6">
                            <input wire:model.defer='type' value='name'
        ...
        <div class="container-fluid flex">
            <div class="m-1 flex flex-row text-right">
                <a type="button" href="{{ route('usuario.create') }}"
                            ...
                            @if ($type == 'name')
                                @if ($direction == 'asc')
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                        class="ml-0.5 bi bi-arrow-up-short" viewBox="0 0 16 16">
                                        <path fill-rule="evenodd"
                    ...
                    @foreach ($usuarios as $usuario)
                        <tr class="bg-white border-b">
                            ...
                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                {{ $usuario->email }}</td>
                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                @if ($usuario->tipo_user == 'medico')
                                    Medico
                                @endif
                                @if ($usuario->tipo_user == 'paciente')
                                    Paciente
                                @endif
                                @if ($usuario->tipo_user == 'admi')
                                    Administrador
                                @endif
                            </td>
                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
