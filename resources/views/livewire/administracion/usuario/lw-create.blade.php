<div>
    <x-header-multi>
        <h6 class="font-medium leading-tight text-base">Añadir Usuario</h6>
    </x-header-multi>
    <div class="modal-body relative p-4 ">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div class="form-group mb-6">
                <label for="exampleInputEmail2" class="form-label inline-block mb-2 text-gray-700">Contraseña</label>
