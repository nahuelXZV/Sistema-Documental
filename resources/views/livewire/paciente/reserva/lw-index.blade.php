    ...
    <x-header-table>
        ...
        <div class="container-fluid flex">
            <div class="m-1 flex flex-row text-right">
                <a type="button" href="{{ route('reservas.create') }}"
                ...
                <tbody>
                    @foreach ($reservas as $reserva)
                        <tr class="bg-white border-b">
                            ...
                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                {{ $reserva->ficha->medico->nombre }} {{ $reserva->ficha->medico->apellido }}</td>
                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                {{ $reserva->ficha->especialidad->nombre }}</td>
                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                {{ $reserva->fecha_reserva }} / {{ $reserva->ficha->horario->dia }}</td>
                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                            ...
                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center justify-center">
                                    <div class="inline-flex" role="group">
                                        ...
                                        <button type="button" wire:click='delete({{ $reserva->id }} )'
