<div>
    <x-header-multi>
        <h6 class="font-medium leading-tight text-base text-black">Perfil de la clinica</h6>
    </x-header-multi>
    ...
    <div class=" p-6 rounded-lg shadow-lg bg-white form-control">
        <div class="grid grid-cols-2 gap-4">
            ...
            <div class="form-group mb-6">
                ...
                <input type="text" readonly value="{{ $clinica->nombre }}"
            ...
            <div class="form-group mb-6">
                ...
                <input type="text" readonly value="{{ $clinica->telefono }}"
                    class="form-control block  w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300  rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
        ...
        <div class="form-group mb-6">
            <label for="exampleInputEmail2" class="form-label inline-block mb-2 text-gray-700">
                Dirección</label>
            <input type="text" readonly value="{{ $clinica->direccion }}"
                class="form-control block  w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300  rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
        ...
        <div class="form-group mb-6">
            ...
            <input type="text" readonly value="{{ $clinica->email }}"
                class="form-control block  w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300  rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
        ...
        <div class="grid grid-cols-2 gap-4">
            <div class="form-group mb-6">
                ...
                <input type="text" readonly value="{{ $clinica->region_sanitaria }}"
                    class="form-control block  w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300  rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
            ...
            <div class="form-group mb-6">
                <label for="exampleInputEmail2" class="form-label inline-block mb-2 text-gray-700">
                    Ciudad</label>
                <input type="text" readonly value="{{ $clinica->ciudad }}"
                    class="form-control block  w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300  rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                    placeholder="Ciudad">
            </div>
        </div>
        <div class="flex space-x-2 justify-start">
            <div>
                ...
                <a type="button" href="{{ route('clinica.edit', $clinica->id) }}"
