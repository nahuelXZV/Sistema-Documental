<div class="m-1">
    ...
    <x-header-table>
                ...
                <ul class=" dropdown-menu
                    ...
                    <li>
                        <div class="form-check ml-2">
                            <input wire:model.defer='type' value='apellido'
                                class="form-check-input appearance-none rounded-full h-4 w-4 border border-gray-300 bg-white checked:bg-blue-600 checked:border-blue-600  mt-1 align-top  mr-2"
                                type="radio" name="flexRadioDefault" id="flexRadioDefault1">
                            <label class="form-check-label inline-block text-gray-800" for="flexRadioDefault1">
                                Apellido
                    ...
                    <li>
                        <div class="form-check ml-2">
                            <input wire:model.defer='type' value='telefono'
                                class="form-check-input appearance-none rounded-full h-4 w-4 border border-gray-300 bg-white checked:bg-blue-600 checked:border-blue-600  mt-1 align-top  mr-2"
                                type="radio" name="flexRadioDefault" id="flexRadioDefault1">
                            <label class="form-check-label inline-block text-gray-800" for="flexRadioDefault1">
                                Telefono
                    ...
                    <li>
                        <div class="form-check ml-2">
                            <input wire:model.defer='type' value='sexo'
                                class="form-check-input appearance-none rounded-full h-4 w-4 border border-gray-300 bg-white checked:bg-blue-600 checked:border-blue-600  mt-1 align-top  mr-2"
                                type="radio" name="flexRadioDefault" id="flexRadioDefault1">
                            <label class="form-check-label inline-block text-gray-800" for="flexRadioDefault1">
                                Sexo
        ...
        <div class="container-fluid flex">
            <div class="m-1 flex flex-row text-right">
                <a type="button" href="{{ route('medicos.create') }}"
                ...
                <ul class="dropdown-menu min-w-max absolute hidden bg-white text-base z-50 float-left
                    ...
                    <li>
                        <p class="dropdown-item flex text-sm py-2 px-4 font-normal w-full
                        whitespace-nowrap bg-transparent text-gray-700 hover:bg-gray-100 "
                            wire:click='order("apellido")'>Apellido
                            <x-signo-table :type='$type' :direction='$direction' etiqueta='apellido'> </x-signo-table>
                        </p>
                    </li>
                    <li>
                        <p class="dropdown-item flex text-sm py-2 px-4 font-normal w-full
                        whitespace-nowrap bg-transparent text-gray-700 hover:bg-gray-100 "
                            wire:click='order("telefono")'>Telefono
    ...
    <x-table>
            ...
            @if ($medicos->count())
                <thead class="border-b bg-gray-800 ">
                    <tr>
                        ...
                        <th scope="col" class="text-sm font-bold text-white px-6 py-4">
                            Sexo
                            <x-signo-table :type='$type' :direction='$direction' etiqueta='sexo'> </x-signo-table>
                        </th>
                        <th scope="col" class="text-sm font-bold text-white px-6 py-4">
                            Telefono
                            <x-signo-table :type='$type' :direction='$direction' etiqueta='telefono'> </x-signo-table>
                            ...
                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center justify-center">
                                    <div class="inline-flex" role="group">
                                        ...
                                        <button type="button" wire:click='delete({{ $medico->id }} )'
        ...
        <x-pagination :modelo='$medicos'> </x-pagination>
    </x-table>
</div>
