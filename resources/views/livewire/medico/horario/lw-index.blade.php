                ...
                <ul class=" dropdown-menu
                    ...
                    <li>
                        <div class="form-check ml-2 mr-6">
                            <input wire:model.defer='type' value='dia'
                    ...
                    <li>
                        <div class="form-check ml-2">
                            <input wire:model.defer='type' value='hora_inicio'
                                class="form-check-input appearance-none rounded-full h-4 w-4 border border-gray-300 bg-white checked:bg-blue-600 checked:border-blue-600  mt-1 align-top  mr-2"
                                type="radio" name="flexRadioDefault" id="flexRadioDefault1">
                            <label class="form-check-label inline-block text-gray-800" for="flexRadioDefault1">
                                Hora de inicio
                    ...
                    <li>
                        <div class="form-check ml-2">
                            <input wire:model.defer='type' value='hora_fin'
                                class="form-check-input appearance-none rounded-full h-4 w-4 border border-gray-300 bg-white checked:bg-blue-600 checked:border-blue-600  mt-1 align-top  mr-2"
                                type="radio" name="flexRadioDefault" id="flexRadioDefault1">
                            <label class="form-check-label inline-block text-gray-800" for="flexRadioDefault1">
                                Hora de fin
                ...
                <ul class="dropdown-menu min-w-max absolute hidden bg-white text-base z-50 float-left
                    ...
                    <li>
                        <p class="dropdown-item flex text-sm py-2 px-4 font-normal w-full
                            whitespace-nowrap bg-transparent text-gray-700 hover:bg-gray-100 "
                            wire:click='order("nombre")'> Dia
                            <x-signo-table :type='$type' :direction='$direction' etiqueta='dia'> </x-signo-table>
                        </p>
                    </li>
                    <li>
                        <p class="dropdown-item flex text-sm py-2 px-4 font-normal w-full
                        whitespace-nowrap bg-transparent text-gray-700 hover:bg-gray-100 "
                            wire:click='order("apellido")'> Hora de inicio
                            <x-signo-table :type='$type' :direction='$direction' etiqueta='hora_fin'> </x-signo-table>
                        </p>
                    </li>
                    <li>
                        <p class="dropdown-item flex text-sm py-2 px-4 font-normal w-full
                        whitespace-nowrap bg-transparent text-gray-700 hover:bg-gray-100 "
                            wire:click='order("telefono")'>Hora de fin
                            <x-signo-table :type='$type' :direction='$direction' etiqueta='hora_inicio'> </x-signo-table>
                        </p>
                    </li>
                </ul>
            </div>
            ...
            @if ($horarios->count())
                <thead class="border-b bg-gray-800 ">
                    <tr>
                        ...
                        <th scope="col" class="text-sm font-bold text-white px-6 py-4">
                            Hora de fin
                            <x-signo-table :type='$type' :direction='$direction' etiqueta='hora_inicio'>
                            </x-signo-table>
                        </th>
                        <th scope="col" class="text-sm font-bold text-white px-6 py-4">
                            Acciones
